...
Game.prototype.add = function (entityID, componentType, options) {
    ...
    console.log("componentID",componentType, componentID)
...
Game.prototype.remove = function(entityID, componentType, componentID){
 ...
 //Get an entity
  if (arguments.length === 1) {
    return this.entities.remove(componentType, componentID, entityID);
  }
  ...
  this.components.unsetEntity(componentType, componentID, entityID);

  if (this.entities.remove(componentType, componentID, entityID)) {
