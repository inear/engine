...
function Game() {
    ...
    this.entities.on('componentRemoved', this.onComponentRemovedFromEntity.bind(this))
...
Game.prototype.onComponentRemovedFromEntity = function(componentType, entityID){
    var componentId = this.get(entityID,componentType)._id;
...
Game.prototype._update = function (dt) {
    ...
    this.entities.emptyRemoveEntitiesList();
